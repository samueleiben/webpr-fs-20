...
const clockwise = [north, east, south, west, north]; // north a second time allows for easier code (just take the next one, in changeDirection)
const countercw = [north, west, south, east, north];

let snake = [
  // array of positions (snake[0] is the head, then the body parts)
  { x: 10, y: 5 },
  { x: 10, y: 6 },
  { x: 10, y: 7 },
  { x: 10, y: 8 }
